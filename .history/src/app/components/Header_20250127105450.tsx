...
const Header = () => {
  ...
  return (
    ...
    >
      <nav
        className={` h-[41px] w-[90%] md:w-[1280px] flex items-center justify-between 
          absolute top-[100px] left-0 w-full bg-white shadow-lg md:static md:bg-transparent md:shadow-none md:flex md:flex-1 md:justify-center ${
