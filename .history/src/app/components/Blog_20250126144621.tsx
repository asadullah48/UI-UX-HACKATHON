        ...
        {blog.map((list, index) => (
          ...
          >
            ...
            <div className="p-4 flex flex-col gap-2">
              ...
              <Link
                href={list.url}
                className="text-base sm:text-lg font-light text-gray-700 text-black font-[poppins] border-b-2  border-black hover:text-gray-500 hover:border-gray-500 transition duration-300"
              >
                Read More
              </Link>
