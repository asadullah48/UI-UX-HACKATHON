...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      >
        <ul className="flex items-center justify-between  flex flex-col md:flex-row items-center text-[16px] font-[poppins] ml-4 sm:ml-8 md:ml-28 font-medium md:gap-[20px] lg:gap-[40px]">
