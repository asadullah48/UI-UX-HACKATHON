...
const HeroSection = () => {
  return (
    <section className="relative flex items-center  max-w-full h-screen px-8 md:px-48 bg-[#FBEBB5] select-nonerelative flex items-center  max-w-full h-screen px-8 md:px-48 bg-[#FBEBB5] select-none">
        {/* Text Section */}
