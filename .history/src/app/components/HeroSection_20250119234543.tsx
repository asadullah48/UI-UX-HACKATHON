...
const HeroSection = () => {
  return (
    <section className=" bg-[#FBEBB5] max-w-full mx-auto max-h-screen relative flex flex-col sm:flex-row items-center sm:justify-between px-8 md:px-48 select-none">
