  ...
  return (
    <section className="relative flex flex-col sm:flex-row items-center max-w-full h-screen px-8 md:px-48 bg-[#FBEBB5] select-none">
      ...
      <div className="flex flex-col items-center sm:items-start text-center sm:text-left sm:w-1/2">
        ...
        <h2 className="mt-4 text-[16px] sm:text-[20px] lg:text-[24px] font-medium PoppinsPopp text-black bg-yellow-500 px-6 py-2 rounded-md transition-transform hover:scale-105">
          Shop Now
        </h2>
